 ...
 *   2. `process.argv[1]` if it's our cli.js — true when genesis is currently
 ...
 * SIGTERM to the running process. When the running genesis cli.js was itself
...
<dict>
    ...
    <string>/tmp/genesis.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/genesis.error.log</string>
</dict>
</plist>`;

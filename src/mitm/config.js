...
const MODEL_PATTERNS = {
  ...
  cursor: [
    ...
    { match: /gpt-5\.5-extra-high|gpt5\.5-extra-high/i, alias: "gpt-5.5-extra-high" },
    { match: /gpt-5\.5-high|gpt5\.5-high/i, alias: "gpt-5.5-high" },
    { match: /gpt-5\.5-medium|gpt5\.5-medium/i, alias: "gpt-5.5-medium" },
    { match: /gpt-5\.5-low|gpt5\.5-low/i, alias: "gpt-5.5-low" },
    { match: /gpt-5\.5-none|gpt5\.5-none/i, alias: "gpt-5.5-none" },
    { match: /gpt-5\.5|gpt5\.5/i, alias: "gpt-5.5-medium" },
    { match: /gpt-5\.4|gpt5\.4/i, alias: "gpt-5.4-medium" },
    { match: /grok/i, alias: "grok-4.3" },
    { match: /kimi/i, alias: "kimi-k2.5" },

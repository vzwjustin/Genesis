...
export default function SidebarSecurityHint() {
  ...
  return (
    <Link
      ...
      className="mx-3 mb-2 flex items-center gap-2 rounded-lg border border-amber-500/25 bg-warning/10 px-2.5 py-2 text-xs text-amber-800 dark:text-amber-200 hover:bg-amber-500/15 transition-colors"

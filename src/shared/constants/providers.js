...
export const APIKEY_PROVIDERS = {
  ...
  fusion: { id: "fusion", alias: "fusion", name: "OpenRouter Fusion", icon: "hub", color: "#F97316", textIcon: "FU", website: "https://openrouter.ai/openrouter/fusion", notice: { text: "Multi-model deliberation: a panel of expert models answers in parallel, then a judge synthesizes a final answer. Uses your OpenRouter API key. Priced as the sum of all panel members + judge (~4–5× a single completion). Override the panel/judge via the `plugins` field (analysis_models, model).", apiKeyUrl: "https://openrouter.ai/settings/keys" }, serviceKinds: ["llm"] },
  ...
  comfyui: { id: "comfyui", alias: "comfyui", name: "ComfyUI", icon: "account_tree", color: "#4CAF50", textIcon: "CF", website: "https://github.com/comfyanonymous/ComfyUI", serviceKinds: [], hidden: true },
  ...
  // === Free-tier LLM providers — DISABLED in UI ===

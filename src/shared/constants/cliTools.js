...
export const MITM_TOOLS = {
  ...
  cursor: {
    ...
    defaultModels: [
      ...
      { id: "gpt-5.5-extra-high", name: "GPT 5.5 Extra High", alias: "gpt-5.5-extra-high" },
      { id: "gpt-5.5-high", name: "GPT 5.5 High", alias: "gpt-5.5-high" },
      { id: "gpt-5.5-medium", name: "GPT 5.5 Medium", alias: "gpt-5.5-medium" },
      { id: "gpt-5.5-low", name: "GPT 5.5 Low", alias: "gpt-5.5-low" },
...
export const CLI_TOOLS = {
  claude: {
    ...
    defaultModels: [
      ...
      { id: "opus", name: "Claude Opus", alias: "opus", envKey: "ANTHROPIC_DEFAULT_OPUS_MODEL", defaultValue: "cc/claude-opus-4-8[1m]" },

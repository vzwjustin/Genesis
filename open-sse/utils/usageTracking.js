 ...
 */
export function logUsage(provider, usage, model = null, connectionId = null, apiKey = null, idempotencyKey = null) {
  ...
  saveRequestUsage({ model, provider, connectionId, tokens, apiKey: apiKey || undefined, idempotencyKey: idempotencyKey || null }).catch(() => { });

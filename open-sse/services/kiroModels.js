 ...
 * API. They are genesis fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic genesis variant set for a single upstream Kiro model.
 *
 ...
 * into genesis variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *

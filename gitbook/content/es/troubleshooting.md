...
Problemas comunes y soluciones al usar Genesis.
...
1. **Refresh automático (por defecto):**
   Genesis refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si Genesis está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep genesis
...
- **GitHub Issues:** [github.com/decolua/genesis/issues](https://github.com/decolua/genesis/issues)

...
Genesis es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Genesis proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Genesis usando estas configuraciones:

**Genesis local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Genesis (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a Genesis
```bash
# Verifica si Genesis está corriendo
...
**Solución:**
- Verifica que Genesis esté corriendo
...
- Verifica la conexión de red a Genesis

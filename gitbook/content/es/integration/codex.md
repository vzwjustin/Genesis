...
Integra Genesis con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Genesis.
...
Genesis proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de Genesis
...
1. Verifica que el nombre del modelo coincida con tu configuración de Genesis
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Genesis
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de Genesis.

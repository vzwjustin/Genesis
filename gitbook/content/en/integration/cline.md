...
Integrate Genesis with Cline VSCode extension to route your AI requests through Genesis's intelligent routing system.
...
Set the base URL to your Genesis endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your Genesis endpoint
...
3. The key should start with `sk-genesis-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your Genesis configuration
...
4. Cline will use Genesis to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using Genesis
...
3. Get AI-powered explanations through Genesis

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use Genesis to understand context and make changes
...
2. Verify your Genesis instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check Genesis logs for any errors
...
1. In Cline settings, set Base URL to: `https://genesis.com`
2. Make sure you have configured your API key in the Genesis cloud dashboard
...
## Integration with Genesis Features

### Model Routing

Genesis automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, Genesis automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through Genesis dashboard:
- Total requests
- Token usage
- Cost per model

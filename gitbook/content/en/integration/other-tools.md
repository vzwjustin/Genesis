...
Genesis is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Genesis provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Genesis using these settings:
...
**Problem:** Cannot connect to Genesis
```bash
...
- Check network connection to Genesis

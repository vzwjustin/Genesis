...
Integrate Genesis with Claude Code CLI to route your Anthropic API requests through Genesis's intelligent routing system.
...
Claude Code supports the following model aliases that map to Genesis models:

...
Integrate Genesis with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Genesis API key from [dashboard](https://genesis.com/dashboard)
- Genesis running (local or cloud)
...
### 2. Add Genesis Model Configuration
...
3. Choose your preferred Genesis model
...
- Check network latency to Genesis

...
**Genesis 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**是的,Genesis 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.genesis`(或自定义 `DATA_DIR`)
- 不会发送数据到 Genesis 服务器
...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/decolua/genesis/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.genesis`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/decolua/genesis/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [genesis.com/docs](https://genesis.com/docs)

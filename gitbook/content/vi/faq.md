...
Những câu hỏi phổ biến về Genesis.

---

## Genesis là gì?

**Genesis là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Genesis dùng chiến lược pricing 3 tầng:**
...
## Genesis có miễn phí không?

**Có, Genesis hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Genesis.**
...
**Genesis theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Genesis không?

**Có! Genesis hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.genesis`)
...
**Có, Genesis ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.genesis` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Genesis
...
## Làm thế nào để cập nhật Genesis?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/genesis/blob/main/CHANGELOG.md)
- Backup `~/.genesis` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/genesis/blob/main/CONTRIBUTING.md) để biết chi tiết.

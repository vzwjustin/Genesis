...
Tích hợp Genesis với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Genesis API key từ [dashboard](https://genesis.com/dashboard)
- Genesis đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra Genesis đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến Genesis

...
Tích hợp Genesis với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của Genesis.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model Genesis:

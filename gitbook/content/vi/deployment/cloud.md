...
Triển khai Genesis trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.genesis` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/genesis`:
...
# If NOT using reverse proxy, allow Genesis ports
